...
const RollingNews = () => {
  ...
  useEffect(() => {
    ...
    // Run first cycle immediately or after short delay if preferred
    // The reference puts it after loopDuration initially?
    // "cycleTimer = setTimeout(runCycle, loopDuration);" -> Yes, it waits 5s before first roll.
